...
class CAR:
  ...
  GRANDEUR2020 = "GRANDEUR IG HEV 2020"   
  GRANDEUR_HEV2020 = "GRANDEUR IG HEV 2020"   
  NEXO = "HYUNDAI NEXO"
  # kia
...
FEATURES = {
  ...
  "use_cluster_gears": {CAR.ELANTRA, CAR.KONA, CAR.ELANTRA_GT_I30, CAR.CADENZA, CAR.GRANDEUR, CAR.GRANDEUR2020},
  ...
  "use_elect_gears": {CAR.OPTIMA_HEV, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.SONATA_HEV, CAR.NIRO_EV, CAR.CADENZA_HEV,
                      CAR.GRANDEUR_HEV2020, CAR.GRANDEUR_HEV, CAR.NEXO, CAR.NIRO_HEV},
  ...
  "use_elect_ems": {CAR.OPTIMA_HEV, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.SONATA_HEV, CAR.NIRO_EV, CAR.CADENZA_HEV,
                    CAR.GRANDEUR_HEV2020, CAR.GRANDEUR2020, CAR.GRANDEUR_HEV, CAR.NEXO, CAR.NIRO_HEV},
  # send LFA MFA message for new HKG models
  "send_lfa_mfa": {CAR.GRANDEUR_HEV2020, CAR.GRANDEUR2020, CAR.GRANDEUR_HEV, CAR.GRANDEUR},
  "has_scc13": set([]), 
  "has_scc14": set([]), 
  # these cars use the FCA11 message for the AEB and FCW signals, all others use SCC12
  "use_fca": {CAR.SONATA, CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.STINGER, CAR.IONIQ, CAR.KONA, CAR.KONA_EV, CAR.FORTE,
              CAR.GRANDEUR_HEV2020, CAR.GRANDEUR2020, CAR.GRANDEUR_HEV, CAR.GRANDEUR, CAR.PALISADE, CAR.GENESIS_G70},

  "use_bsm": {CAR.SONATA, CAR.PALISADE, CAR.GENESIS, CAR.GENESIS_G70, CAR.GENESIS_G80, CAR.GENESIS_G90,
              CAR.GRANDEUR_HEV2020, CAR.GRANDEUR2020, CAR.GRANDEUR_HEV, CAR.GRANDEUR, CAR.GENESIS_G90_L, CAR.KONA, CAR.OPTIMA_HEV},
...
DBC = {
  ...
  CAR.GRANDEUR2020: dbc_dict('hyundai_kia_generic', None),
  CAR.GRANDEUR_HEV2020: dbc_dict('hyundai_kia_generic', None),  
